  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: IntrinsicHeight( // Add this to ensure the column takes full height when content is less
          child: Column(
            children: [
              Expanded( // Wrap your main content in Expanded
                child: Container(
              ...
              // Now the copyright text is always at the bottom
              const Padding(
                padding: EdgeInsets.all(8.0),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center, // Use center for better alignment in mobile view
                  children: [
                    Text(
